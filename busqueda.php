...
<div class="main-content">
				<div class="content-page">
					<div>
	<div class="title-section"> Buscando resultados para <?php echo $_GET['texto'];?> </div>
...
<?php 
include('con_db.php');
$consulta=$enlace ->query("SELECT * FROM productos WHERE nombre like '%".$_GET['texto']."%'  or 
	descripcion like '%".$_GET['texto']."%'


	order by id DESC limit 20")or die ($enlace ->error);
